...
describe('tests metrics', () => {
   it('Get steps', (done) => {
    ...
    it('Get steps - undefined start time', (done) => {
        let newMetric = new StepsMetric({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687872508',
    ...
    it('Get steps - undefined end time', (done) => {
        let newMetric = new StepsMetric({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687872508',
    ...
    it('Get sleep - undefined start time', (done) => {
        let newMetric = new SleepMetric({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687872508',
    ...
    it('Get sleep - undefined end time', (done) => {
        let newMetric = new SleepMetric({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687872508',
    ...
    it('Get distance - undefined start time', (done) => {
        let newMetric = new DistanceMetric({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687872508',
    ...
    it('Get distance - undefined end time', (done) => {
        let newMetric = new DistanceMetric({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687872508',
    ...
    it('Get calories - undefined start time', (done) => {
        let newMetric = new CaloriesMetric({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687872508',
    ...
    it('Get calories - undefined end time', (done) => {
        let newMetric = new CaloriesMetric({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687872508',
    ...
    it('Get activity', (done) => {
        ...
        newMetric.save(function (error) {
            ...
            request.get('/auth/patients/metrics/getActivity')
                .set('Content-Type', 'application/json')
                .set('x-auth-token', token)
                .query(query)
                .then(res => {
