...
describe('tests patients answers', () => {
    it('Get getDailyAnswers - undefined start time', (done) => {
        ...
        newMetric.save(function (error) {
            ...
            request.get('/auth/patients/answers/getDailyAnswers')
                ...
                .then(res => {
                    ...
                    expect(obj.data[0].UserID.UserID).toEqual(userIdHash);
    ...
    it('Get getPeriodicAnswer', (done) => {
        ...
        newMetric.save(function (error) {
            ...
            request.get('/auth/patients/answers/getPeriodicAnswers')
                .set('Content-Type', 'application/json')
                .set('x-auth-token', token)
                .query(query)
                .then(res => {
    ...
    it('Get getPeriodicAnswer - undefined start time', (done) => {
        let newMetric = new PeriodicAnswer({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687850376',
    ...
    it('Get getPeriodicAnswer - undefined end time', (done) => {
        let newMetric = new PeriodicAnswer({
            UserID: userIdHash,
            Timestamp: '1585687850376',
            ValidTime: '1585687850376',
